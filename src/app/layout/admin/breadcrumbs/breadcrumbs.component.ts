            ...
            if (routes.outlet === 'primary') {
              ...
              if (routes.snapshot.data.breadcrumb !== undefined) {
                ...
                if (!this.tempState.includes(routes.snapshot.data.breadcrumb)) {
                 ...
                 console.log(breadcrumb_caption,'it')
                  if (routes.snapshot.data.breadcrumb == 'Button') {
                    routes.snapshot.data.breadcrumb = 'Usuarios'
                  }
                  
                  if (routes.snapshot.data.breadcrumb = 'Basic Components') {
                    routes.snapshot.data.breadcrumb = 'Administración'
                  }
